...
#include "../../../../Scene/Shape/Traced/Sphere.h"

class SphereSerializer : public ItemSerializer<Object*>
{
public:
	SphereSerializer(ItemSerializer<Vec3f>* vec3fSerializer, KeyedItemSerializer<UvSurface*>* uvSurfaceSerializer) {
